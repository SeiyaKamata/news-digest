...
NOTION_TOKEN=<token> NOTION_NEWS_DATABASE_ID=<db_id> \
  python3 .claude/skills/news-digest/scripts/fetch_news.py
```
...
NOTION_TOKEN=<token> NOTION_DWM_DATABASE_ID=<dwm_db_id> \
  python3 .claude/skills/news-digest/scripts/find_daily.py
```
...
}' | NOTION_TOKEN=<token> python3 .claude/skills/news-digest/scripts/append_digest.py <page_id>
```
